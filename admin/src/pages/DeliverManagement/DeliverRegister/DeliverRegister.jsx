        ...
        <form>
          <div className="dRSectionRight">
            ...
            <div className="dRForm">
              <div className="dRFormLeft">
                <div className="dRInputBox">
                  <label className="dRLableName">
                    Full Name <span className="dRLable">*</span>
                  </label>
                  <input
                    type="text"
                    name="firstName"
                ...
                <div className="dRInputBox">
                  <label className="dRLableName">
                    NIC Number <span className="dRLable">*</span>
                  </label>
                  <input
                    type="text"
                    name="nicNumber"
                ...
                <div className="dRInputBox">
                  <label className="dRLableName">
                    Date of Birth <span className="dRLable">*</span>
                  </label>
                  <input
                    type="date"
                    name="dateOfBirth"
                ...
                <div className="dRInputBox">
                  <div className="dRFile">
                    <label className="dRLableName">
                      Deliver Photo <span className="dRLable">*</span>
                    </label>
                    <input
                      type="file"
                      required
                ...
                <div className="dRInputBox">
                  <label className="dRLableName">
                    Password <span className="dRLable">*</span>
                  </label>
                  <input
                    type="password"
                    name="password"
              ...
              <div className="dRFormRight">
                ...
                <div className="dRInputBox">
                  <label className="dRLableName">
                    Email <span className="dRLable">*</span>
                  </label>
                  <input
                    type="text"
                    name="email"
                ...
                <div className="dRInputBox">
                  <label className="dRLableName">
                    Address <span className="dRLable">*</span>
                  </label>
                  <input
                    type="text"
                    name="address"
                ...
                <div className="dRInputBox">
                  <label className="dRLableName">
                    Gender <span className="dRLable">*</span>
                  </label>
                ...
                <div className="dRInputBox">
                  <div className="dRFile">
                    <label className="dRLableName">
                      License Photo <span className="dRLable">*</span>
                    </label>
                    <input
                      type="file"
                      required
                ...
                <div className="dRInputBox">
                  <label className="dRLableName">
                    Confirm Password <span className="dRLable">*</span>
                  </label>
                  <input
                    type="password"
            ...
            <div className="dRButtons">
              <button type="reset" className="dRReset">
                Reset
              </button>
              {uploaded === 2 ? (
